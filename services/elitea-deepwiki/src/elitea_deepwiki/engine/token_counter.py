...
import os as _os
CONTEXT_TOKEN_BUDGET = int(_os.getenv("DEEPWIKI_CONTEXT_TOKEN_BUDGET", "80000"))  # Max tokens for one-shot generation (full content)
...
class TokenCounter:
    ...
    def count_document(self, doc: Any, include_metadata: bool = True) -> int:
        ...
        if include_metadata:
            ...
            metadata_text_parts = []
            for key in ['symbol_name', 'file_path', 'symbol_type', 'expansion_reason', 
                       'expansion_source', 'expansion_via']:
