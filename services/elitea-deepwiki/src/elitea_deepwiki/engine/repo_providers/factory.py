...
Converts platform toolkit configurations (from elitea-sdk) into GitCloneConfig
objects that can be used by our filesystem-based wiki generator.

Supported toolkit types (matching elitea-sdk names):
...
class RepoProviderFactory:
    ...
    def from_toolkit_config(
        ...
        Args:
            ...
            config: Toolkit configuration dict (matches elitea-sdk schemas)
    ...
    def from_url(
        ...
        """
        Create GitCloneConfig from a repository URL with optional credentials.
        
        This auto-detects the provider from the URL.
    ...
    def _normalize_config(
        ...
        Maps the various configuration fields from elitea-sdk to our normalized format.
        """
    ...
    @staticmethod
    def _extract_ado_org(url: str) -> Optional[str]:
