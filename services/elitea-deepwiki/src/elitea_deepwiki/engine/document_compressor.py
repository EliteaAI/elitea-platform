...
class DocumentCompressor:
    ...
    def _is_documentation_file(self, symbol_type: str, language: str, file_type: str) -> bool:
        ...
        doc_symbol_types = {
            'readme', 'documentation', 'markdown', 'text_chunk',
            'config', 'configuration', 'text', 'plain_text'
        }
        ...
        doc_languages = {
            'markdown', 'text', 'plain_text', 'restructuredtext',
    ...
    def _compress_to_summary(self, content: str, metadata: dict) -> str:
        ...
        summary_lines = [
            f"# {symbol_type.title()}: {symbol_name}",
            f"File: {file_path}",
            f"Language: {language}"
        ]
    ...
    def _extract_typescript_class_signature(self, content: str) -> str:
        ...
        for line in lines:
            ...
            if (stripped.startswith('class ') or 
                ...
                stripped.startswith('export default class ')):
                result.append(line)
    ...
    def _extract_java_class_signature(self, content: str) -> str:
        ...
        for line in lines:
            ...
            if (stripped.startswith('public class ') or 
                ...
                stripped.startswith('public interface ')):
                result.append(line)
                continue
    ...
    def _extract_rust_signature(self, content: str) -> str:
        ...
        for line in lines:
            ...
            if any(stripped.startswith(kw) for kw in ['pub struct', 'struct', 'pub trait', 
                                                       'trait', 'impl', 'pub enum', 'enum']):
                result.append(line)
                if '{' in line:
