...
class RepositoryAnalysisStore:
    ...
    def __init__(self, cache_dir: Optional[str] = None):
        ...
        Args:
            cache_dir: Directory for storing analysis files. 
                       Defaults to ~/.elitea/wiki_indexes
        """
        if cache_dir is None:
            cache_dir = "~/.elitea/wiki_indexes"
    ...
    def _analysis_key_str(
        ...
        analysis_key_override: Optional[str] = None,
    ) -> str:
    ...
    def _get_cache_key_for_analysis_key(self, analysis_key: str) -> str:
        ...
        return hashlib.md5(str(analysis_key).encode()).hexdigest()
    
    def _get_cache_key(self, repo_identifier: str, commit_hash: Optional[str] = None) -> str:
    ...
    def _find_analysis_by_prefix(self, repo_identifier: str) -> Optional[Any]:
        """
...
def parse_structured_analysis(analysis_text: str) -> Optional[Dict[str, Any]]:
    """
...
def match_capabilities_to_query(
    analysis_text: str,
    query: str,
