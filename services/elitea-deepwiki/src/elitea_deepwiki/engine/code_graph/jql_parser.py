...
class JQLQuery:
    ...
    @property
    def layer_value(self) -> Optional[str]:
    ...
    @property
    def file_value(self) -> Optional[str]:
    ...
    @property
    def name_value(self) -> Optional[str]:
    ...
    @property
    def related_value(self) -> Optional[str]:
    ...
    @property
    def connections_clause(self) -> Optional[JQLClause]:
...
def _parse_clause(text: str) -> Optional[JQLClause]:
