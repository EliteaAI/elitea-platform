...
and wiki generation, without dependencies on the full EliteA SDK GitHubClient.
...
class StandaloneGitHubClient:
    ...
    Simple Python class that extracts plugin_implementation functionality from EliteA SDK's GitHubClient
