...
// the wrong count. Getting it wrong here would fail the driver's width
// assertion, which is the intended behaviour: the assertion measures the
// decode, not the transport.
