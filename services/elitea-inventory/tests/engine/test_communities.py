"""Ported from inventory_plugin/tests/test_communities.py.
...
from elitea_inventory.engine.inventory.communities import (
    CommunityAnalyzer,
    _get_edge_weight,
    _normalize_scores,
...
class TestRetrievalFormatting:
    ...
    def _make_wrapper(self, kg, tmp_path):
        ...
        from elitea_inventory.engine.inventory.retrieval import InventoryRetrievalApiWrapper
