# Copied from inventory_plugin methods/inventory_chat.py by tools/refresh_engine_copy.py.
#
...
from .engine.utils.langfuse_callback import (
...
class Method:
    ...
    def inventory_chat(
        ...
        try:
            ...
            from .engine.routing import QueryRouter, ToolSelector, PromptBuilder, GraphProfile
