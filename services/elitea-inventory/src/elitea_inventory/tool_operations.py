# Copied from inventory_plugin methods/invoke.py by tools/refresh_engine_copy.py.
#
...
class Method:
    ...
    def _get_or_create_wrapper(self, graph_path, request_data=None):
        ...
        """
        import os
        from .engine import InventoryRetrievalApiWrapper
    ...
    def _tool_run_ingestion(self, params, graph_path, request_data):
        ...
        import json as json_module
        from pathlib import Path
        from .engine.utils.ingestion_tracker import IngestionSlotError
        from .engine.utils.source_status import SourceStatusManager
        ...
        try:
            ...
            from .engine import IngestionPipeline
    ...
    def _run_ingestion_job(self, params, graph_path, request_data):
        ...
        from .engine.k8s_ingestion_job_manager import get_ingestion_job_manager
        ...
        try:
            ...
            tracking_task_id = self.invocation_id
        except Exception:
            pass
    ...
    def _tool_list_presets(self, params, graph_path, request_data):
        ...
        from .engine import list_presets, PRESETS
    ...
    def _tool_get_preset_info(self, params, graph_path, request_data):
        """Get preset details"""
        from .engine import get_preset, PRESETS
