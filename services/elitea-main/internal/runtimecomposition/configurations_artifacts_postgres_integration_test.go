...
-- The skills pair is part of the minimum project schema because the tenant
-- history alters it (tenant/0122_skill_publishing.sql, #249), the same way
-- application_versions above is here for 0121.
