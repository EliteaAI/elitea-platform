...
func TestProductionRouterMountsOnlyCurrentPromptContextGETs(t *testing.T) {
	...
	// (promptcontextreadsapi.CurrentProjectContextPath), which is why
	// mountReviewedProductionRoutes never registers it in production (#243) —
	// asserting its behavior belongs with the broad router's own tests, not
	// this reviewed-surface unit test.
