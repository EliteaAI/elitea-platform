...
func TestProductionRouterMatchesMainComposedRouteSurface(t *testing.T) {
	...
	want := []string{
		...
		"DELETE /api/v2/support_assistant/conversation/{conversationUUID}",
		"DELETE /api/v2/support_assistant/messages/{conversationUUID}",
		...
		"POST /api/v2/support_assistant/attachments/{conversationUUID}",
