...
same failure. The service entrypoint still must install the production
subscriber, redaction policy and metric exporter before deployment; adding
that wiring is not a reason to defer the current semantic spans.
