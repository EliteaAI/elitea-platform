...
existing call-bound hierarchy. Raw incremental tool-progress chunks remain a
separate gap, as does nested saved-pipeline HITL-card hierarchy. Approved
effectful calls also remain closed for production until durable
