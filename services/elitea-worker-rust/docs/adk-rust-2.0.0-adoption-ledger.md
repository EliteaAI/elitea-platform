...
refer to platform OAuth/DCR, runtime-discovered configured families, SharePoint,
the documented remaining OpenAPI capabilities and production activation. Root, pipeline-LLM,
...
aggregation, platform OAuth/DCR, SharePoint and remaining configured-family gaps. Main's
