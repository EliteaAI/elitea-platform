...
import { useSelectedProject } from '@/widgets/app-shell/model/useSelectedProject.hooks';

import {
  CODE_EXAMPLE_TYPES,
} from '@/routes/_shell/settings/ai-configuration/codeExamples';
import {
  generateCanvasTitle,
  generateCodeExample,
  getEditorLanguage,
  getFileNameForLanguage,
} from '@/routes/_shell/settings/ai-configuration/codeExamples.helpers';
...
export function useCodePreview(model: Record<string, unknown> | null) {
