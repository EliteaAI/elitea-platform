 ...
 * Its two-argument shape is fixed by unit S1's interim contract
 * (`src/shared/ui/lib/t.ts`) — do not narrow it without updating that file
 * and its call sites; widening (as this module already does with the
 * optional third `options` argument) is safe.
 */
export { t } from './t';
