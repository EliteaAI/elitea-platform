...
export const MessageTraceStep = zod
  .object({
    id: zod.int(),
    message_group_id: zod.int(),
    kind: zod.string().describe("`tool_call` or `thinking_step`."),
    tool_name: zod.string().nullish(),
    parent_agent_name: zod.string().nullish(),
...
export type MessageTraceStep = zod.input<typeof MessageTraceStep>;
export type MessageTraceStepOutput = zod.output<typeof MessageTraceStep>;
