/**
 * Port of `apps/elitea-ui/src/[fsd]/features/interactive-tours/lib/constants/pipelineTour.constants.js`
 */

import type { TourStep } from '../types';

import { PIPELINE_TOUR_TARGETS } from './pipelineTourTargets.constants';
...
export const pipelineTourSteps: TourStep[] = [
  {
    id: 'what-is-pipeline',
