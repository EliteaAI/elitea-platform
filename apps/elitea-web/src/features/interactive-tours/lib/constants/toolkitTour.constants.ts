/**
 * Port of `apps/elitea-ui/src/[fsd]/features/interactive-tours/lib/constants/toolkitTour.constants.js`
 */

import type { TourStep } from '../types';

import { SHARED_TOUR_TARGETS } from './interactiveTour.constants';
import { TOOLKIT_TOUR_TARGETS } from './toolkitTourTargets.constants';
...
export const toolkitTourSteps: TourStep[] = [
  {
    id: 'what-is-toolkit',
