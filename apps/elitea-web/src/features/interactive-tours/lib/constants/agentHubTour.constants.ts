/**
 * Port of `apps/elitea-ui/src/[fsd]/features/interactive-tours/lib/constants/agentHubTour.constants.js`
 */

import type { TourStep } from '../types';

import { AGENT_HUB_TOUR_TARGETS } from './agentHubTourTargets.constants';
...
export const agentHubTourSteps: TourStep[] = [
  {
