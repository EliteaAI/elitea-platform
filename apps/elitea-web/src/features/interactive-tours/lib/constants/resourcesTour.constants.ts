/**
 * Port of `apps/elitea-ui/src/[fsd]/features/interactive-tours/lib/constants/resourcesTour.constants.js`
 */

import type { TourStep } from '../types';

import { RESOURCES_TOUR_TARGETS } from './resourcesTourTargets.constants';
