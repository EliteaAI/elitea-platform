/**
 * Port of `apps/elitea-ui/src/[fsd]/features/interactive-tours/lib/constants/aiConfigurationTour.constants.js`
 */
...
export const aiConfigurationTourSteps: TourStep[] = [
  {
