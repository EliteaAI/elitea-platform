/**
 * Port of `apps/elitea-ui/src/[fsd]/features/interactive-tours/lib/constants/notificationsTour.constants.js`
 */

import type { TourStep } from '../types';

import { SIDEBAR_TOUR_TARGETS } from './sidebarTourTargets.constants';
