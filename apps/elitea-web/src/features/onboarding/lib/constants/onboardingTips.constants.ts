 ...
 * Port of `apps/elitea-ui/src/[fsd]/features/onboarding/lib/constants/onboardingTips.constants.js`
 * (Wave-2 unit A13).
 *
 * Tip text is raw Markdown — it renders through the Markdown component on the
 * client. Images live under `@/assets/onboarding/tips/` in the new app.
 */

// Tip 1 — Welcome to ELITEA
import tip01 from '@/assets/onboarding/tips/welcome-interface.png';
// Tip 2 — Navigate the Sidebar
import tip02 from '@/assets/onboarding/tips/sidebar-navigation.png';
// Tip 3 — Switch Between Projects
import tip03 from '@/assets/onboarding/tips/project-selector.png';
// Tip 4 — Chat is Your Command Center
import tip04 from '@/assets/onboarding/tips/first-chat.png';
// Tip 5 — Choose Your AI Model
import tip05 from '@/assets/onboarding/tips/model-selection.png';
// Tip 6 — Send Your First Message
import tip06 from '@/assets/onboarding/tips/first-message.png';
// Tip 7 — Understanding Participants
import tip07 from '@/assets/onboarding/tips/participants-panel.png';
// Tip 8 — Connect Your First Toolkit from Chat
import tip08 from '@/assets/onboarding/tips/create-toolkit-start.png';
// Tip 9 — Configure Jira Toolkit
import tip09 from '@/assets/onboarding/tips/toolkit-types.png';
// Tip 10 — Create Credentials from Toolkit
import tip10 from '@/assets/onboarding/tips/create-credentials.png';
// Tip 11 — Return and Select Your Credential
import tip11 from '@/assets/onboarding/tips/toolkit-configuration.png';
// Tip 12 — Enable Jira Tools
import tip12 from '@/assets/onboarding/tips/enable-tools.png';
// Tip 13 — Save and Use Your Toolkit
import tip13 from '@/assets/onboarding/tips/toolkit-in-chat.png';
// Tip 14 — Add AI Assistants with #
import tip14 from '@/assets/onboarding/tips/add-assistants.png';
// Tip 15 — What Are Agents?
import tip15 from '@/assets/onboarding/tips/what-are-agents.png';
// Tip 16 — Start Creating an Agent
import tip16 from '@/assets/onboarding/tips/create-agent-start.png';
// Tip 17 — Fill Required Agent Fields
import tip17 from '@/assets/onboarding/tips/agent-required-fields.png';
// Tip 18 — Write Agent Instructions
import tip18 from '@/assets/onboarding/tips/agent-instructions.png';
// Tip 19 — Add Welcome Message (Optional)
import tip19 from '@/assets/onboarding/tips/agent-welcome.png';
// Tip 20 — Add Chat Starters
import tip20 from '@/assets/onboarding/tips/agent-starters.png';
// Tip 21 — Save Initial Configuration
import tip21 from '@/assets/onboarding/tips/agent-first-save.png';
// Tip 22 — Select AI Model for Agent
import tip22 from '@/assets/onboarding/tips/agent-select-model.png';
// Tip 23 — Configure Model Settings
import tip23 from '@/assets/onboarding/tips/agent-model-settings.png';
// Tip 24 — Your Agent is Created!
import tip24 from '@/assets/onboarding/tips/agent-created.png';
// Tip 25 — Test Your New Agent
import tip25 from '@/assets/onboarding/tips/test-agent.png';
// Tip 26 — Edit Agents Anytime
import tip26 from '@/assets/onboarding/tips/edit-agent.png';
// Tip 27 — Add Toolkits to Agents
import tip27 from '@/assets/onboarding/tips/add-toolkit-to-agent.png';
// Tip 28 — What Are Pipelines?
import tip28 from '@/assets/onboarding/tips/what-are-pipelines.png';
// Tip 29 — Start Creating a Pipeline
import tip29 from '@/assets/onboarding/tips/create-pipeline-start.png';
// Tip 30 — Configure Pipeline Basics
import tip30 from '@/assets/onboarding/tips/pipeline-config.png';
// Tip 31 — Save to Unlock Flow Editor
import tip31 from '@/assets/onboarding/tips/pipeline-save-first.png';
// Tip 32 — Access the Flow Editor
import tip32 from '@/assets/onboarding/tips/flow-editor-tab.png';
// Tip 33 — Add Nodes to Your Workflow
import tip33 from '@/assets/onboarding/tips/pipeline-nodes.png';
// Tip 34 — Design Your Workflow Visually
import tip34 from '@/assets/onboarding/tips/design-workflow.png';
// Tip 35 — Configure Pipeline Model & Toolkits
import tip35 from '@/assets/onboarding/tips/pipeline-model-toolkits.png';
// Tip 36 — Save and Test Your Pipeline
import tip36 from '@/assets/onboarding/tips/test-pipeline.png';
// Tip 37 — Enable File Attachments
import tip37 from '@/assets/onboarding/tips/attachment-setup.png';
// Tip 38 — Attach Files to Chat
import tip38 from '@/assets/onboarding/tips/attach-files.png';
// Tip 39 — Add Human Teammates (Team Projects Only)
import tip39 from '@/assets/onboarding/tips/add-teammates.png';
// Tip 40 — Mention Teammates with @
import tip40 from '@/assets/onboarding/tips/mention-teammates.png';
// Tip 41 — Edit Participants Using Canvas
import tip41 from '@/assets/onboarding/tips/edit-in-canvas.png';
// Tip 42 — Copy and Regenerate Responses
import tip42 from '@/assets/onboarding/tips/message-actions.png';
// Tip 43 — Multi-Assistant Collaboration
import tip43 from '@/assets/onboarding/tips/multi-assistant.png';
// Tip 44 — Switch Active Participants
import tip44 from '@/assets/onboarding/tips/switch-assistant.png';
// Tip 45 — Add Participants from Panel
import tip45 from '@/assets/onboarding/tips/add-from-panel.png';
// Tip 46 — Search Your Chats
import tip46 from '@/assets/onboarding/tips/search-conversations.png';
// Tip 47 — Organize Chats with Folders
import tip47 from '@/assets/onboarding/tips/chat-folders.png';
// Tip 48 — View Message Execution Details
import tip48 from '@/assets/onboarding/tips/message-details.png';
...
export const onboardingTips: OnboardingTip[] = [
  {
    tip:
