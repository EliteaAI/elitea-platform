...
class ProtocolLimitsV1(_message.Message):
    __slots__ = ("limits_revision", "max_worker_command_bytes", "max_signed_envelope_bytes", "max_redis_field_bytes", "max_redis_entry_bytes", "max_input_manifest_bytes", "max_input_entries", "max_input_content_bytes", "max_output_frame_bytes", "max_validation_issues", "max_safe_string_bytes", "claim_lease_ttl_millis", "max_lease_poll_interval_millis", "max_grpc_request_bytes", "max_grpc_response_bytes")
