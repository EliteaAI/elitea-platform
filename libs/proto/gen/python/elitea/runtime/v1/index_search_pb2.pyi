...
class IndexSearchOperationV1(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    INDEX_SEARCH_OPERATION_V1_UNSPECIFIED: _ClassVar[IndexSearchOperationV1]
    INDEX_SEARCH_OPERATION_V1_SEARCH_INDEX: _ClassVar[IndexSearchOperationV1]
    INDEX_SEARCH_OPERATION_V1_STEPBACK_SEARCH_INDEX: _ClassVar[IndexSearchOperationV1]
    INDEX_SEARCH_OPERATION_V1_LIST_INDEXES: _ClassVar[IndexSearchOperationV1]
INDEX_SEARCH_OPERATION_V1_UNSPECIFIED: IndexSearchOperationV1
INDEX_SEARCH_OPERATION_V1_SEARCH_INDEX: IndexSearchOperationV1
INDEX_SEARCH_OPERATION_V1_STEPBACK_SEARCH_INDEX: IndexSearchOperationV1
...
class IndexSearchArtifactReferenceV1(_message.Message):
...
class IndexSearchResultV1(_message.Message):
    ...
    toolkit_configuration: IndexSearchInputBindingV1
    tool_parameters: IndexSearchInputBindingV1
    llm_model: IndexSearchInputBindingV1
